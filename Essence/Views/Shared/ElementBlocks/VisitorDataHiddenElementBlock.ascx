...
<input name="<%: formElement.ElementName %>" id="<%: formElement.Guid %>" type="hidden" class="Form__Element FormHidden FormHideInSummarized" <%= Model.AttributesString %> data-f-type="hidden" />
<% } %>