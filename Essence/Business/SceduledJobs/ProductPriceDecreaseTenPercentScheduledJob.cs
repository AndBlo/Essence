...
{
    [ScheduledPlugIn(DisplayName = "Product Price Decrease Ten Percent")]
    public class ProductPriceDecreaseTenPercentScheduledJob : ScheduledJobBase
    {
        private bool _stopSignaled;
        private readonly IContentRepository repo;

        public ProductPriceDecreaseTenPercentScheduledJob(IContentRepository repo)
        {
            this.repo = repo;
            IsStoppable = true;
        }
        ...
        public override string Execute()
        {
            ...
            foreach (var pListPage in listPages)
            {
                ...
                foreach (var page in productPages)
                {
                    ...
                    var newPrice = clone.ProductPrice * 0.9;
