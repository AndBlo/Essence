...
<% if (Model.Form != null) { %>
<div class="EPiServerForms row">
    <div class="col-lg-6 col-md-12 col-sm-12">
        <h4 class="Form__Title"><%: Html.PropertyFor(m => m.Title) %></h4>
        <h5 class="Form__Description"><%: Html.PropertyFor(m => m.Description) %></h5>
    </div>
    <div class="col-lg-6 col-md-12 col-sm-12">
...
<% if (ViewBag.RenderingFormUsingDivElement) { %>
    ...
    <% if (!string.IsNullOrEmpty(Model.Description)) { %><aside class="Form__Description"><%: Model.Description %></aside> <br /> <% }%>
